...
<div id="menu">  <!-- 왼쪽 메뉴 나오는거 -->
    <div class="menu-inner">
        ...
        <div style="position:absolute; left:20px; bottom:250px; width: 350px; float: left;"> 
        ...
        <div style="position:absolute; left:20px; bottom:450px; width: 350px; float: left; "> 
...
<div class="all">
    <div id="section1">
        <div class="input-form-backgroud row"> <h1>&nbsp;&nbsp; &nbsp;&nbsp;전체 게시판</h1> </div>
            <div class="container">  
...
<?php
   /* 게시글 정보 가져오기  */
	$query5 = "SELECT * FROM uploads ORDER BY upload_number DESC LIMIT $page_start, $list";
