...
<div class="container"> 
        <div class="input-form-backgroud row"> 
            <div class="input-form col-md-12 mx-auto">
                ...
                <br></br><h3><strong>글 쓰기</strong></h3><h7>&nbsp;Travel Map Memory Write Page</h7>
                    <div class="bar"></div>
                            <br><br><br>
                            <form action="writeProcess.php" method="POST" name = "writeform" enctype="multipart/form-data">
                                <div class="mb-5" style="width:670px; height:50px; text-align:center; ">
                                    <tr> <td> <a> 계절과 지역을 선택해주세요.</a><br>
                                    <select  style = "text-align:center; width: 120px; font-family: 'Jua'; background: #FFFFFF; border: 3px solid #ADA1C5; " name = "season" id="write_season"> 
                                    ...
                                    <select  style = "text-align:center; width: 150px; font-family: 'Jua'; background: #FFFFFF; border: 3px solid #ADA1C5; " name = "city" id="write_city">
                                ...
                                <tr> <td><input style = " background: #E6E6FA; font-family: 'Jua' " type="text" class="form-control"  placeholder="글 제목" name="title" id="write_title"></td> </tr></div>
                                <tr> <td><textarea  style = "background: #E6E6FA; font-family: 'Jua'; height:260px " type = "text" class="form-control" placeholder="세부적인 시, 군, 구와 내용을 입력해주세요  :" name="text" id="write_text"></textarea></td> </tr>
                                <div style="height:50px;">
                                    <input  style = "margin:0.5em; font-family: 'Jua';" type="file" name="file" id="file"></div>
                                <button style = "font-family: 'Jua'; float: right;" type="button" id = "write_button" class="btn btn-dark mb-3" onclick ="writeCheck()">글쓰기</button>  
                            </form>
                            </div>  
            </div>
        </div>
...
<script> 
    function writeCheck()
    {
        ...
        const writefile = document.getElementById('file').value;
        const writeseason = document.getElementById('write_season').value;
        const writecity = document.getElementById('write_city').value;
